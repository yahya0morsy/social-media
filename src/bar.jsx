...
function Navbar() {
  let navigate = useNavigate()
   function clicker(item){
    ...
    return (
      <div className="w-screen h-8 lg:h-screen lg:w-8 bg-zinc-700 rounded-lg flex flex-row justify-center lg:flex-col">
        <ul className="grid grid-flow-row gap-4 lg:grid-flow-col lg:grid-cols-1 lg:gap-24 lg:grid-rows-5 grid-cols-5 grid-rows-1 mx-2 ">
