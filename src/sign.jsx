        ...
        <div className="w-screen h-screen flex flex-col justify-center">
            <div className="flex flex-col text-red-800 place-self-center">
                ...
                <div className='item absolute flex flex-row justify-center bg-red-700 z-10 rounded-md' id='item'>
                    ...
                    <div className='flex flex-row text-white text-base sm:text-lg my-2 mx-2 font-medium flex-wrap-reverse'>password:<input type='password' className='rounded-md mx-1 text-black'/><div className=''><button className='text-black rounded-lg hover:cursor-pointer active:translate-x-2 duration-200 active:translate-y-2 active:bg-slate-600 border-2 border-black bg-white'
