...
function Sign(){
    ...
    function hiderdw(){
       ...
       else if(parseFloat(window.getComputedStyle(document.getElementById('item')).width)==350){x=200}
        anime({
            targets: '.item',
            translateY: x
          });
            ...
            <div className="flex flex-col text-red-800 place-self-center">
                ...
                <div className='item absolute flex flex-row justify-center bg-red-700 z-10 rounded-md' id='item'>
                    ...
                    <div className='flex flex-row justify-center'><p className='text-2xl text-white'>Sign up</p></div>
                        <div className='text-white text-base font-medium my-3'>Username:<input type='text' className='rounded-md mx-1'/></div>
                    ...
                    <div className='text-white text-lg my-3 mx-2 font-medium'>Username:<input type='text' className='rounded-md mx-1'/></div>
                    <div className='flex flex-row text-white text-lg my-2 mx-2 font-medium'>password :<input type='password' className='rounded-md mx-1'/><div className=''><button className='text-black rounded-lg hover:cursor-pointer active:translate-x-2 duration-200 active:translate-y-2 active:bg-slate-600 border-2 border-black bg-white'
                                                                                                                                                                                 onClick={()=>navigate('/home')}>submit</button></div></div>
                    <div className='mx-2 text-blue-500 hover:cursor-pointer'>forger password ?</div>
